...
| Trees and ensembles | CART, random forest, Extra-Trees, stump boosting, exact and histogram XGBoost-style objectives, LightGBM-style leaf-wise growth, ranking, monotonic constraints, interaction groups, sampling, serialization, slicing, warm starts, and validation stopping | Bagging, AdaBoost, categorical partitions, Tweedie, DART, GOSS, EFB, distributed workers, SHAP-compatible explanations, warm-start LightGBM, and resident GPU histograms |
