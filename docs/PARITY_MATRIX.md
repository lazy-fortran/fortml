...
| Optimizers | SGD momentum/Nesterov, Adam/AdamW, Adagrad, RMSprop, unfactored Adafactor, bounded FortOpt L-BFGS-B, schedules, checkpoints, and contiguous CPU optimizer groups | Matrix-factored Adafactor, Lion, RAdam, AMSGrad, cosine/plateau schedules, AMP with loss scaling, gradient accumulation, EMA, distributed state, migration, and resident multi-layer GPU training |
