...
| --- | --- | --- |
| Linear and GLM | Linear, ridge, elastic-net/lasso, fixed-hyperparameter weighted Bayesian ridge, weighted SVR, Poisson/Gamma log-link GLMs, logistic and softmax heads | Positive ridge, Bayesian evidence maximisation/ARD, quantile, robust losses, SGD estimators, multinomial GLM, partial-fit, sparse inputs, and resident GPU kernels |
