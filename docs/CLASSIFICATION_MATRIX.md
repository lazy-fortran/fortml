...
| Gaussian-process classifiers | Binary/shared-kernel Laplace, OVR Laplace, variational Bernoulli, coupled categorical, ordinal and multilabel wrappers | Sorted labels, predictive probabilities, inducing-state products, likelihood temperature products, FortOpt slices and CUDA refusals | Full likelihood catalog, natural gradients, batch/multitask state, complete likelihood/kernel HVPs, resident inference |
