...
| Trees and boosting | CART, random/extra forests, bagging, AdaBoost, XGBoost and LightGBM adapters | Weighted fits, missing routing, constraints, staged margins, persistence, binary and multiclass stable log-probabilities, packed leaf-coordinate products, multi-output adapters, typed CUDA boundaries | SAMME.R, EFB, distributed growth, SHAP interactions, resident GPU histograms |
