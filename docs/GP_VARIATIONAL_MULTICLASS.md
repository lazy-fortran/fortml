...
normalization with respect to the packed per-class variational state.  These
products hold query points and kernel hyperparameters fixed; query-feature and
kernel-parameter products are separate roadmap work.
