...
| Exact GPs | `fortml_kernels`, `fortml_gaussian_process`, `fortml_gp_training`, `fortml_derivative_gaussian_process`, `fortml_derivative_gp_training`, `fortml_multi_output_gp` | Exact-GP hyperparameters and mixed value/first-derivative GP states expose bounded FortOpt adapters. Derivative-observation hypergradient coverage remains kernel-dependent and is recorded explicitly in the roadmap. |
