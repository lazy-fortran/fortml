...
XGBoost-style boosting with squared/logistic/Poisson/Tweedie/Huber/quantile/absolute objectives
...
The classification surface also includes `fortml_gp_variational_categorical_classification`:
