...
| --- | --- | --- |
| Linear regression, ridge/elastic-net estimators, scalers, basis maps, and basis pipelines | Value, input/parameter JVPs and VJPs; analytic HVPs for polynomial/Chebyshev/Fourier/radial/spline maps and horizontal/column/sequential/fan-out/residual-sum pipelines; versioned transactional state dictionaries for fitted horizontal unions | Conditional/cyclic DAG transforms, callback HVPs, fit-time derivatives, graph/estimator-wide and resident-device serialization remain open |
