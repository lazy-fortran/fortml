...
trainer now has an in-memory resumable checkpoint API, AdamW and FortOpt-backed
SGD, and binary logistic objectives have a bounded FortOpt L-BFGS-B adapter. A
fixed full-batch MLP trajectory also exposes exact learning-rate/L2
...
| Dense MLP and MSE training objective | Parameter/input JVPs, VJPs, exact MSE+L2 HVPs, L2 hyperparameter derivative, Adam/AdamW/SGD momentum/Nesterov training, and exact fixed-trajectory learning-rate/L2 hypergradients | Other losses, optimizer-trajectory schedules, and neural module families are partial |
| Exact GP regression | Kernel-parameter products, input derivatives, prediction products, and differentiated-solve HVPs; RBF first-order products and Matérn 1/2 HVPs use proven FortSym-generated leaves | Approximate and matrix-free training products are partial; Matérn 3/2 and 5/2 HVPs retain FortAD products |
