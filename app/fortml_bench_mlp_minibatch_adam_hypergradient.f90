program fortml_bench_mlp_minibatch_adam_hypergradient
    !! Release workload for the deterministic mini-batch Adam hypergradient.
    ...
    elapsed = real(clock_end-clock_start, dp)/real(clock_rate, dp) &
        /real(repetitions, dp)
    write (*, '(a,es24.16)') "mlp_minibatch_adam_hypergradient_value_gradient,", elapsed
...
end program fortml_bench_mlp_minibatch_adam_hypergradient
