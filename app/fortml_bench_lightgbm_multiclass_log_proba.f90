program fortml_bench_lightgbm_multiclass_log_proba
    !! Release workload for stable multiclass LightGBM log probabilities and
    ...
    write (*, '(a,1x,es24.16)') "lgbm_mc_log_fit_seconds", finish_time - start_time
    ...
    write (*, '(a,1x,es24.16)') "lgbm_mc_log_roundtrip_error", roundtrip_error
    ...
    write (*, '(a,1x,es24.16)') "lgbm_mc_log_input_jvp_error", input_error
    ...
    write (*, '(a,1x,es24.16)') "lgbm_mc_log_input_vjp_error", input_duality
    ...
    write (*, '(a,1x,es24.16)') "lgbm_mc_log_parameter_vjp_error", parameter_duality
    ...
    write (*, '(a,1x,i0)') "lgbm_mc_log_cuda_status", cuda_status

end program fortml_bench_lightgbm_multiclass_log_proba
