...
The checklist currently records 306 completed and 129 open items; open rows are
...
revision `104d93c` (the canonical integration is `f7c47ba`; subsequent commits
only refresh documentation), FortAD `origin/main` at
...
`f7c47ba`/`814f6de` pair recorded above.
