...
| Regression and bases | OLS, ridge, elastic-net, weighted linear SVR, Poisson/Gamma GLM, PCA, polynomial/Fourier/radial/spline maps, analytic basis/pipeline HVPs, sequential or column pipelines, and robust/squared-log/quantile XGBoost-style objectives | Tweedie, partial fit, sparse views, graph serialization, differentiable basis hyperparameters, callback/pipeline second derivatives, and resident GPU execution |
...
`93f41d6` and `fortsym` `main` at `b72a23a`. The checked-in RBF HVP/product
