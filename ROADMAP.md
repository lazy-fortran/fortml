...
| --- | --- | --- |
| GNU Fortran | `fo` | Static, build, test, and lint checks passed. The fresh 2026-08-07 run passed all 128 tests (286 modules; 748 build units). See [`verification/fortml-gfortran.txt`](verification/fortml-gfortran.txt). |
