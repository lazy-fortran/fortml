...
- [x] Add a bounded, separately named LightGBM-style numeric histogram and
  ...
  GOSS, EFB, categorical statistics, external-data iterators, persistence, and
  resident GPU histograms remain separate gaps.
