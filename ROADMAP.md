...
The checklist currently records 353 completed and 127 open items; open rows are
...
- [ ] Add weighted OLS, positive-constrained, ARD regression, Huber, Theil-Sen,
  RANSAC, quantile, and Tweedie regression. Solvers expose
